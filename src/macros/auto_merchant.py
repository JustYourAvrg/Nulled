...
class AutoMerchant:
    def __init__(self, init_ref):
        ...
        self.link_checks = self.helper.link_checks()
    ...
    def handle_merchant(self):
        ...
        try:
            merchant_name_screenshot = pyautogui.screenshot(region=[
                self.data['auto_merchant']['merchant name pos'][0],
                self.data['auto_merchant']['merchant name pos'][1],
                self.data['auto_merchant']['merchant name pos'][2],
                self.data['auto_merchant']['merchant name pos'][3]
            ])
            ...
            if str(checked_merchant_name).lower() in ['mari', 'jester']:
                ...
                for _ in range(5):
                    ...
                    merchant_item_screenshot = pyautogui.screenshot(region=[
                        self.data['auto_merchant']['item name pos'][0],
                        self.data['auto_merchant']['item name pos'][1],
                        self.data['auto_merchant']['item name pos'][2],
                        self.data['auto_merchant']['item name pos'][3]
                    ])
                    ...
                    if checked_merchant_item in self.items_to_buy:
                        ...
                        autoit.mouse_click('left', self.merchant_positions['amount button'][0], self.merchant_positions['amount button'][1], clicks=2)

                        keys = [str(self.amount), '{enter}']
