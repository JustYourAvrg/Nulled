...
class UI(ctk.CTk):
    ...
    def create_gui(self):
        ...
        self.bottom_bar = ctk.CTkFrame(self.main_frame, width=380, height=35, corner_radius=6, bg_color="#1e1e1e", fg_color="#131313")
        ...
        self.upload_config_button = ctk.CTkButton(self.bottom_bar, 
            text="Upload Config", 
            fg_color="#1a1a1a", 
            hover_color="#1d1d1d",
            command=lambda: self.upload_config()
        )
        self.upload_config_button.grid(row=0, column=2, padx=5, pady=5, sticky='nse')


    def upload_config(self):
        try:
            config_path = os.path.join(pathlib.Path(__file__).parents[2].resolve(), 'config.json')
            ...
            if os.path.exists(config_path):
                ...
                if file:
                    ...
                    if os.path.exists(file_path):
                        choice = self.popup.askconfirmation(f"Are you sure you want to submit the config file from | {file_path}")
                        if choice:
                            ...
                            self.popup.showinfo(f"Config successfully updated")
                    
        except Exception as e:
            handle_log_msg('ERROR', e)
            self.popup.showerror(f"An error has accured uploading config file")
            return
    ...
    def update_enabled_status(self, item, checkbox: ctk.CTkSwitch):
    ...
    def create_macro_frame(self):
        ...
        self.toggle_container.grid(row=0, column=0, padx=5, pady=10, sticky='nsew', ipady=5, ipadx=5)
        ...
        self.toggle_auto_randomizer = ctk.CTkSwitch(self.toggle_container, text="Biome Randomizer", fg_color='#1c1c1c', progress_color="#3c3c3c", button_color="#c4c4c4")
        ...
        self.auto_randomizer_interval.grid(row=0, column=1, sticky='e')
        ...
        self.toggle_auto_controller = ctk.CTkSwitch(self.toggle_container, text="Strange Controller", fg_color='#1c1c1c', progress_color="#3c3c3c", button_color="#c4c4c4")
        ...
        self.auto_controller_interval.grid(row=1, column=1, sticky='e')
        ...
        self.auto_merchant = ctk.CTkSwitch(self.toggle_container, text="Auto Merchant", fg_color='#1c1c1c', progress_color="#3c3c3c", button_color="#c4c4c4")
        ...
        self.auto_merchant_interval.grid(row=2, column=1, sticky='e')
        ...
        self.toggle_detect_auras = ctk.CTkSwitch(self.toggle_container, text="Detect Auras", fg_color='#1c1c1c', progress_color="#3c3c3c", button_color="#c4c4c4")
        ...
        self.clip_aura_keybind.grid(row=3, column=1, sticky='e')
        ...
        self.toggle_detect_biome = ctk.CTkSwitch(self.toggle_container, text="Detect Biome", fg_color='#1c1c1c', progress_color="#3c3c3c", button_color="#c4c4c4")
        ...
        self.interval_container = ctk.CTkFrame(self.macro_frame, fg_color="#151515")
        self.interval_container.grid(row=0, column=1, padx=5, pady=10, sticky='nsew', ipady=5, ipadx=5)

        self.interval_container.grid_rowconfigure([0, 1, 2], weight=1)
        self.interval_container.grid_columnconfigure(0, weight=1)


        self.biome_randomizer_interval = ctk.CTkLabel(self.interval_container, 
        ...
        self.strange_controller_interval = ctk.CTkLabel(self.interval_container, 
