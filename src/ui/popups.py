...
class Popup:
    ...
    def showinfo(self, message: str):
        ...
        width = self.info_root.winfo_reqwidth()
        height = self.info_root.winfo_reqheight()
        self.info_root.geometry(f"{width+2.5}x{height+2.5}")

        self.info_root.wait_window()
    ...
    def showerror(self, message: str):
        ...
        width = self.error_root.winfo_reqwidth()
        height = self.error_root.winfo_reqheight()
        self.error_root.geometry(f"{width+2.5}x{height+2.5}")
    ...
    def askconfirmation(self, message: str):
        ...
        width = self.confirm_root.winfo_reqwidth()
        height = self.confirm_root.winfo_reqheight()
        self.confirm_root.geometry(f"{width+2.5}x{height+2.5}")
